...
for(i=0; i<charactersNames.length; i++){
  for(j=0; j<femaleCharacters.length; j++){
    if(charactersNames[i] == femaleCharacters[j]){
      charactersNames[i] = charactersNames[charactersNames.length-1];
      charactersNames.pop();    
    }
  }
}
...
const randomNumber = Math.floor(Math.random() * (starWarsCharacters.length-1));
let text;

text = "Il suo nome è " + starWarsCharacters[randomNumber].name+
" ha un altezza di " + starWarsCharacters[randomNumber].height+
" pesa " + starWarsCharacters[randomNumber].mass+
" ha i capelli di color " + starWarsCharacters[randomNumber].hair_color+
" ha il colore della skin " + starWarsCharacters[randomNumber].skin_color+
" ha il colore degli occhi " + starWarsCharacters[randomNumber].eye_color+
" è nato nel " + starWarsCharacters[randomNumber].birth_year+
" ed è un " + starWarsCharacters[randomNumber].gender;
